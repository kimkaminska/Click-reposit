...
public class CheckLenovoLeptopsList extends TestInit {

    @Test
    public void checkLenovoLeptopsList() {
        ...
        sleep(4);
        laptopPage.clickLenovoLeptopsBtn().click();
        sleep(4);

        Assert.assertTrue(laptopPage.checkURLLenovoLeptops());
    }
}
