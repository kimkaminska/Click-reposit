...
public class CheckDellLaptops32GBList extends TestInit {

    @Test
    public void checkDellLaptops32GBList () {
        ...
        sleep(4);
        laptopPage.clickDellLaptopsBtn().click();
        sleep(4);
        laptopPage.cklickDellLaptops32GB().click();
        sleep(4);

        Assert.assertTrue(laptopPage.checkURLDellLaptops32GB());
    }
}
