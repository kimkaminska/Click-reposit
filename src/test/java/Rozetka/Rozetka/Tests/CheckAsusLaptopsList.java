...
public class CheckAsusLaptopsList extends TestInit {

    @Test
    public void checkAsusLaptopList () {
        ...
        sleep(4);
        laptopPage.clickAsusLaptopsBtn().click();
        sleep(4);

        Assert.assertTrue(laptopPage.checkURLAsusLaptops());
    }
}
